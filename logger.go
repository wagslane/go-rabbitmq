...
// Fatalf -
func (l stdDebugLogger) Fatalf(format string, v ...any) {
...
type simpleLogF func(string, ...any)

func (l simpleLogF) Fatalf(format string, v ...any) {
	l(fmt.Sprintf("%s FATAL: %s", loggingPrefix, format), v...)
	os.Exit(1)
}

func (l simpleLogF) Errorf(format string, v ...any) {
	l(fmt.Sprintf("%s ERROR: %s", loggingPrefix, format), v...)
}

func (l simpleLogF) Warnf(format string, v ...any) {
	l(fmt.Sprintf("%s WARN: %s", loggingPrefix, format), v...)
}

func (l simpleLogF) Infof(format string, v ...any) {
	l(fmt.Sprintf("%s INFO: %s", loggingPrefix, format), v...)
}

func (l simpleLogF) Debugf(format string, v ...any) {
